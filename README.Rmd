...
We can also calculate weighted median expenditures. Because the integrated data come from both the Interview and Diary surveys, we'll display them by UCC.
```{r calc_median}
