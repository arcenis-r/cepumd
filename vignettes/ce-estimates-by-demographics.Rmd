---
title: "ce-estimates-by-demographics"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ce-estimates-by-demographics}
...
The below code assumes that CE PUMD zip files and the hierarchical grouping zip file are stored in a path the name of which is stored in a variable called `ce_data_dir` as follows.
